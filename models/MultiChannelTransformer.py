...
class MultiChannelTransformer(nn.Module):
    ...
    def forward(self, channels_output):
        ...
        out_combined = torch.cat(channels_output, dim=-1)
        ...
        emb = self.output_ffwd(out_combined)
...
class TransformerEncoder(nn.Module):
    ...
    def __init__(self, *, dims, temporal_kernel, num_kernel=64,
        ...
        self.transformer = MultiChannelTransformer(
        ...
        # TODO: need an input_process that changes from 16 channels to the number ok tokens (e.g. 64)
        # TODO: maybe replace random pos encoding by sin/cos pos encoding
