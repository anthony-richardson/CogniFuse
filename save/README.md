...
The following commands create the results or the task 'SwitchingTask3Presence'
...
Multi Channel Deformer Without DIP:

CUBLAS_WORKSPACE_CONFIG=:4096:8 python -m run_benchmark --multimodal 1  --model_name ablation.MultiChannelDeformerWithoutDIP.MultiChannelDeformerWithoutDIP --task SwitchingTask3Presence --cuda 1 --device 0 --mlp_dim 16 16 16 16 --num_kernel 65 4 4 4 --emb_dim 261 16 16 16 --heads 16 --dim_head 16
(Parameters: 4952386, scaling factor: 1.02)

-----------

Multi Channel Deformer Without DIP and FTL:

CUBLAS_WORKSPACE_CONFIG=:4096:8 python -m run_benchmark --multimodal 1  --model_name ablation.MultiChannelDeformerWithoutDIPandFTL.MultiChannelDeformerWithoutDIPandFTL --task SwitchingTask3Presence --cuda 1 --device 0 --mlp_dim 16 16 16 16 --num_kernel 65 4 4 4 --emb_dim 260 16 16 16 --heads 16 --dim_head 17
(Parameters: 4950335, scaling factor: 1.02)

-----------

Multi Channel Deformer Without FTL:

CUBLAS_WORKSPACE_CONFIG=:4096:8 python -m run_benchmark --multimodal 1  --model_name ablation.MultiChannelDeformerWithoutFTL.MultiChannelDeformerWithoutFTL --task SwitchingTask3Presence --cuda 1 --device 0 --mlp_dim 16 16 16 16 --num_kernel 64 4 4 4 --emb_dim 255 16 16 16 --heads 16 --dim_head 17
(Parameters: 4956621, scaling factor: 1.01)

-----------

Multi Channel Deformer Without SFE:

CUBLAS_WORKSPACE_CONFIG=:4096:8 python -m run_benchmark --multimodal 1  --model_name ablation.MultiChannelDeformerWithoutSFE.MultiChannelDeformerWithoutSFE --task SwitchingTask3Presence --cuda 1 --device 0 --mlp_dim 16 16 16 16 --num_kernel 66 4 4 4 --emb_dim 264 16 16 16 --heads 16 --dim_head 16
(Parameters: 4948744, scaling factor: 1.03)

-----------

Multi Channel Deformer Wthout MCE layers

This is exactly the same model as the intermediate fusion deformer (see above). 
